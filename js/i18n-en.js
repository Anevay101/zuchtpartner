...
(() => {
  ...
  const EN = {
    ...
    'Kernwerte auf einen Blick. Turnierwerte zeigen die vier stärksten vollständig berechenbaren Disziplinen; die Zuchtschau-Prognose erscheint nur ohne echten ZS-Wert.':'Core metrics at a glance. Competition values show the four strongest fully calculable disciplines; the breeding-show forecast appears only when there is no actual show score.',
    '4 stärkste Turnierwerte':'4 strongest competition values',
    'Keine vollständigen Turnierwerte berechenbar.':'No complete competition values can be calculated.',
    ...
    'Bewertung & Partnerfilter':'Scoring & partner filters', 'Bewertung & Sortierung':'Scoring & sorting',
    'Gegenpartner filtern':'Filter partner', 'Optionale Verfeinerung':'Optional refinement', '🎨 Farbwünsche':'🎨 Colour preferences',
    'Ausgangspferd wählen; passende Gegenpartner werden anschließend automatisch gerankt.':'Select the starting horse; suitable partners are then ranked automatically.',
    'Nur verwenden, wenn du die Partnerauswahl zusätzlich eingrenzen möchtest.':'Use only if you want to narrow the partner selection further.',
    ...
    'Typischer Bereich':'Typical range', 'Meldeniveau':'Entry level', 'Durchkommen':'Qualifying cutoff', 'Podium':'Podium', 'Siegniveau':'Winning level', 'Datengrundlage':'Data basis',
    'Aktuelles Durchkommen':'Current qualifying cutoff', 'Einordnung':'Assessment',
    'Gute Chancen':'Good chances', 'Anspruchsvoll':'Demanding', 'Cup-Stern erforderlich':'Cup star required', 'Nicht einschätzbar':'Cannot assess',
    ...
    'Aus den letzten bis zu 50 besetzten Schauen':'From the latest up to 50 completed shows',
    'Noch keine passende Ergebnisliste eingelesen.':'No matching results list has been imported yet.',
    'Typischer Bereich = P25–P75 aller Meldungen; Meldeniveau = Median aller Meldungen; Podium = typischer 3. Platz; Siegniveau = typischer Gewinner.':'Typical range = P25–P75 of all entries; entry level = median of all entries; podium = typical 3rd place; winning level = typical winner.',
    'Durchkommen = letzter erfolgreicher Platz nach 1:3-Regel (abgerundet).':'Qualifying cutoff = last successful place under the 1-in-3 rule (rounded down).',
    'Durchkommen = letzter erfolgreicher Platz nach 1:5-Regel (abgerundet).':'Qualifying cutoff = last successful place under the 1-in-5 rule (rounded down).',
    'Schauen unter der nötigen Mindestbesetzung werden nur für das Durchkommensniveau ignoriert.':'Shows below the required minimum entry count are ignored only for the qualifying cutoff.',
    ...
    'Zuchtschau-Prognose':'Breeding-show forecast', 'Aktuelles Zuchtschau-Niveau':'Current breeding-show level',
    'DB-Prognose Grundwert':'Database forecast baseline', 'Aktueller Turnierbonus':'Current competition bonus',
    'Aktueller Cup-Stern-Bonus':'Current Cup-star bonus', 'Schätzwert mit aktuellem Bonus':'Estimate with current bonus',
    'Typisches Durchkommen':'Typical qualifying cutoff', 'Über Schwelle':'Above cutoff', 'Unter Schwelle':'Below cutoff',
  ...
  if (typeof MDR_TOURNAMENT_UI_TRANSLATIONS !== 'undefined') {
    Object.assign(EN, MDR_TOURNAMENT_UI_TRANSLATIONS);
  }
  ...
  window.MDR_I18N_EN_DATA = { EN, ATTR_EN, DYNAMIC_EN, STATIC_REPLACEMENTS };
})();
